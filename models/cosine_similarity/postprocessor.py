...
class OutputBatchApplications(StandardOutputBatch):
    ...
    @classmethod
    def test_func(cls, batch, total_num_codes, num_codes, attention, traceback_attention, article_sentences_lengths, codes=None, labels=None):
        ...
        if codes is not None:
            stats = statistics_func(total_num_codes, num_codes, attention, traceback_attention, article_sentences_lengths, codes, labels=labels)
        else:
            stats = {}
