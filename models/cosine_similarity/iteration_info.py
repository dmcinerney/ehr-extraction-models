...
class BatchInfoApplications(BatchInfo):
    ...
    def test_func(self, batch, num_codes, total_num_codes, attention, traceback_attention, article_sentences_lengths, codes=None, labels=None):
        ...
        if codes is not None:
            stats = statistics_func(num_codes, total_num_codes, attention, traceback_attention, article_sentences_lengths, codes, labels=labels)
        else:
            stats = {}
