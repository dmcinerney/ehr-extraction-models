...
save_checkpoint_folder = 'checkpoints/ehr_extraction_code_supervision/checkpoint7'
#save_checkpoint_folder = None
load_checkpoint_folder = 'checkpoints/ehr_extraction_code_supervision/checkpoint7'
